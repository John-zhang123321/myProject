package com.zl.authority.dao;


import com.zl.authority.Utils.RedisUtil;
import com.zl.authority.Utils.SerializableUtil;
import com.zl.authority.constant.UpmsConstant;
 ...
 * Created by zhangliang on 2018/9/15.
 */
@Repository
public class MySessionDao extends CachingSessionDAO {
    ...
    protected void doUpdate(Session session) {
        ...
        // 更新session的最后一次访问时间
        MySession upmsSession = (MySession) session;
        MySession cacheUpmsSession = (MySession) doReadSession(session.getId());
